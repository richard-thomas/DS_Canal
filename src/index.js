...
// Custom controls: self-geolocation & distance measuring
...
const mousePositionControl = new ol_control_MousePosition({
    coordinateFormat: ol_coordinate_createStringXY(),
...
const distMeasureControl = measureDistance(map, mapConfig.displayProjection);
map.addControl(distMeasureControl);
 ...
 * @returns {Promise} all GeoPackages have finished loading
 */
